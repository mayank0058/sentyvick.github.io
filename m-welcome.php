...
<html lang="en">
  ...
  <li class="nav-item active"><font color='orange'> <img src="https://img.icons8.com/metro/26/000000/guest-male.png"> <?php echo "Welcome ". $_SESSION['username']?></font></a>
      </li>
  </ul>
  </div>
...
<br><br><br><br><br><br><h3><center><font  size="35px" color="orange"><?php echo "Welcome ". $_SESSION['username']?></font></center></h3>
<hr>
