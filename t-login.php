...
if(empty($err))
{
    $sql = "SELECT id, username, password FROM technician WHERE username = ?";
...
<body style="background-color:powderblue;">
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#"><img src="https://img.icons8.com/metro/26/000000/guest-male.png"> <font color='orange'><b>TECHNICIAN Login</b></font></a>
  ...
  <ul class="navbar-nav">
	  ...
	  <a class="nav-link" href="te-ragister.php"><b>Ragister</b></a>
	  </li>
  </ul>
  </div>
</nav>
