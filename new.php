...
<html lang="en">
  ...
  <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="m-welcome.php">Home<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="m-logout.php">Logout</a>
      </li>     
    </ul>
  </div>
</nav>
...
<form action="" method="post">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      <label for="inputState">contect</label>
      <input type="text" class="form-control" name ="contect" id="inputCity">
    </div>
  </div>
